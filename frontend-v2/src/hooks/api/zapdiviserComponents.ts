...
export const fetchUserControllerFindAll = (
  ...
  zapdiviserFetch<undefined, UserControllerFindAllError, undefined, {}, {}, {}>(
    { url: "/api/user", method: "get", ...variables, signal },
  );

export const useUserControllerFindAll = <TData = undefined,>(
  variables: UserControllerFindAllVariables,
  options?: Omit<
    reactQuery.UseQueryOptions<undefined, UserControllerFindAllError, TData>,
    "queryKey" | "queryFn" | "initialData"
  >,
) => {
  const { fetcherOptions, queryOptions, queryKeyFn } =
    useZapdiviserContext(options);
  return reactQuery.useQuery<undefined, UserControllerFindAllError, TData>({
    queryKey: queryKeyFn({
      path: "/api/user",
