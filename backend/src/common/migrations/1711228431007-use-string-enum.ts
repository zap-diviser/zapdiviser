...
export class UseStringEnum1711228431007 implements MigrationInterface {
  name = 'UseStringEnum1711228431007';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "whatsapp" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "deleted_at" TIMESTAMP, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "phone" character varying, "profileUrl" character varying, "status" character varying NOT NULL DEFAULT 'PENDING', "user_id" uuid NOT NULL, CONSTRAINT "PK_17f5e142323073a3c507bbe207c" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
