...
import { QueryOperation } from './zapdiviserComponents';

export type ZapdiviserContext = {
  fetcherOptions: {
    /**
 ...
 */
export function useZapdiviserContext<TQueryFnData = unknown, TError = unknown, TData = TQueryFnData, TQueryKey extends QueryKey = QueryKey>(
